...
(function withAngular(angular, navigator) {
  ...
  var A_DAY_IN_MILLISECONDS = 86400000
    ...
    , generateMonthAndYearHeader = function generateMonthAndYearHeader(prevButton, nextButton) {
      ...
      return [
        '<div class="_720kb-datepicker-calendar-header" style="border-bottom-width: medium;border-bottom-style: solid;border-bottom-color: white;background: transparent;">',
          ...
          '<div class="_720kb-datepicker-calendar-header-middle _720kb-datepicker-calendar-month">',
            '{{month}}&nbsp;',
              '<select ng-model="mobileYear" title="{{ dateYearTitle }}" ng-change="setNewYear(mobileYear)" style="width: 25%; background: transparent; ">',
                '<option ng-repeat="item in paginationYears track by $index" ng-selected="year === item" ng-disabled="!isSelectableMinYear(item) || !isSelectableMaxYear(item)" ng-value="item" value="item" style="color:black;">',
                  '{{ item }}',
                '</option>',
              '</select>',
          '</div>',
    ...
    , generateDaysColumns = function generateDaysColumns() {
      ...
      return [
      '<div class="_720kb-datepicker-calendar-days-header" style="background: transparent;">',
    ...
    , generateDays = function generateDays() {
      ...
      return [
        '<div class="_720kb-datepicker-calendar-body" style="color:white;">',
    ...
    , generateHtmlTemplate = function generateHtmlTemplate(prevButton, nextButton) {
      ...
      var toReturn = [
        '<div class="_720kb-datepicker-calendar _720kb-datepicker-open _720kb-datepicker-forced-to-open {{datepickerClass}} {{datepickerID}}" ng-blur="hideCalendar()" style="width: 90%; left: 5%;">',
        '</div>'
      ]
    ...
    , datepickerDirective = function datepickerDirective($window, $compile, $locale, $filter, $interpolate) {
      ...
      var linkingFunction = function linkingFunction($scope, element, attr) {
        ...
        var selector = attr.selector
          ...
          , theCalendar
          , defaultPrevButton = '<b class="_720kb-datepicker-default-button" style="color:white;">&lang;</b>'
          , defaultNextButton = '<b class="_720kb-datepicker-default-button" style="color:white;">&rang;</b>'
